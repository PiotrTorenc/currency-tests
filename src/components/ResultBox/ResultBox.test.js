    ...
    it('should render proper info about conversion when PLN -> USD', () => {
      ...
      expect(output).toHaveTextContent(
        `${formatAmountInCurrency(
          testObj.amount,
          'PLN'
        )} = ${formatAmountInCurrency(testObj.amount / 3.5, 'USD')}`.replace(
          /\u00a0/g,
          ' '
        )
      );
    ...
    it('should render proper info about conversion when USD -> PLN', () => {
      ...
      expect(output).toHaveTextContent(
        `${formatAmountInCurrency(
          testObj.amount,
          'USD'
        )} = ${formatAmountInCurrency(testObj.amount * 3.5, 'PLN')}`.replace(
          /\u00a0/g,
          ' '
        )
      );
    ...
    it('should render proper info about conversion when USD -> USD', () => {
      ...
      expect(output).toHaveTextContent(
        `${formatAmountInCurrency(
          testObj.amount,
          'USD'
        )} = ${formatAmountInCurrency(testObj.amount, 'USD')}`.replace(
          /\u00a0/g,
          ' '
        )
      );
    ...
    it('should render proper info about conversion when PLN -> PLN', () => {
      ...
      expect(output).toHaveTextContent(
        `${formatAmountInCurrency(
          testObj.amount,
          'PLN'
        )} = ${formatAmountInCurrency(testObj.amount, 'PLN')}`.replace(
          /\u00a0/g,
          ' '
        )
      );
